...
"""Provide the route for the Register Student command."""
...
router = APIRouter(tags=["register_student"])


class RegisterStudentRequest(BaseModel):
    """Request body for the Register Student command."""
...
async def register_student(
    ...
    """Register a new student with a limit on concurrent course subscriptions."""
    try:
        slice_ = app.do(RegisterStudentSlice(**body.model_dump()))
